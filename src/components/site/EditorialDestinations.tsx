  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-7 md:p-9">
        ...
        <span className="mt-5 inline-flex items-center gap-2 text-[11px] uppercase tracking-luxe text-sky-600 dark:text-sky-300 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-500">
