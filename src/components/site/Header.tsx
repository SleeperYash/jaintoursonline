      ...
      >
        ...
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-serif md:text-lg lg:text-xl tracking-wide text-foreground text-base text-sky-400">
              Jain <span className="text-gold italic font-bold text-sky-400">Tours & Travels</span>
            </span>
