  ...
  return (
    <footer id="contact" className="border-t border-border/60 bg-ink mt-32">
      <div className="container py-20 grid gap-12 md:grid-cols-2 lg:grid-cols-4 pt-[60px]">
        ...
        <div>
          <h4 className="uppercase tracking-luxe text-gold mb-6 text-sm text-teal-400">Explore</h4>
        ...
        <div>
          <h4 className="uppercase tracking-luxe text-gold mb-6 text-sm text-teal-400">Services</h4>
          <ul className="space-y-3 text-sm text-muted-foreground">
        ...
        <div>
          <h4 className="uppercase tracking-luxe text-gold mb-6 text-sm text-teal-400">Reach Us</h4>
          <ul className="space-y-4 text-sm text-muted-foreground">
            <li className="flex gap-3">
              <MapPin className="w-4 h-4 mt-0.5 text-gold shrink-0 text-teal-400" />
              <span className="leading-relaxed text-slate-300">{BRAND.address}</span>
            </li>
            <li className="flex gap-3">
              <Phone className="w-4 h-4 mt-0.5 text-gold shrink-0 border-sky-300 text-teal-400" />
              <a href={`tel:${BRAND.phoneDigits}`} className="hover:text-foreground text-slate-300">{BRAND.phoneDisplay}</a>
            </li>
            <li className="flex gap-3">
              <Mail className="w-4 h-4 mt-0.5 text-gold shrink-0 text-teal-400" />
              <a href={`mailto:${BRAND.email}`} className="hover:text-foreground text-slate-300">{BRAND.email}</a>
            </li>
            <li className="flex gap-3">
              <Clock className="w-4 h-4 mt-0.5 text-gold shrink-0 text-teal-400" />
