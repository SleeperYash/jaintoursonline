  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "word-rise": { "0%": { opacity: "0", transform: "translateY(40%)" }, "100%": { opacity: "1", transform: "translateY(0)" } },
        "bounce-slow": { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(6px)" } },
        "orb-drift": { "0%, 100%": { transform: "translate(0, 0)" }, "50%": { transform: "translate(-30px, 20px)" } },
        "ping-gold": { "0%": { transform: "scale(1)", opacity: "0.7" }, "100%": { transform: "scale(2.4)", opacity: "0" } },
      },
      animation: {
        ...
        "ping-gold": "ping-gold 2s cubic-bezier(0, 0, 0.2, 1) infinite",
      },
    },
  },
